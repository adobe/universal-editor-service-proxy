...
By this, users won't need to provide Authentication tokens or similar as requests will include AEM's `login-token` cookie for authentication as all calls (to Universal Editor Service as well as AEM) will have the same origin.
